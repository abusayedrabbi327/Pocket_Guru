import svgPaths from "./svg-r1vzq9q0io";
import imgAnnieSprattTbhOuN6UrguUnsplash1 from "figma:asset/4b05136efbfab92012613114c8ab5f66f9a29250.png";
...
export default function SignUp() {
  return (
    <div className="bg-black relative size-full" data-name="Sign Up">
      <div className="absolute h-[937px] left-[-410px] top-0 w-[1250px]" data-name="annie-spratt-TBHOuN6URGU-unsplash 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover opacity-80 pointer-events-none size-full" src={imgAnnieSprattTbhOuN6UrguUnsplash1} />
      </div>
      <div className="absolute h-[930px] left-[-849px] top-0 w-[1697px]" data-name="photorealistic-money-with-plant 1" />
      <Group />
      <div className="-translate-x-1/2 absolute h-[36px] left-1/2 top-[755px] w-[142px]">
      ...
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium h-[30px] leading-[normal] left-[215px] not-italic text-[18px] text-black text-center top-[761px] w-[86px] whitespace-pre-wrap">Send OTP</p>
      <div className="absolute bg-[rgba(255,221,54,0.9)] h-[46px] left-[41px] rounded-[16px] top-[419px] w-[346px]" />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[62px] not-italic text-[18px] text-[rgba(0,0,0,0.43)] top-[431px]">Name</p>
      <div className="absolute bg-[#ffdd36] h-[46px] left-[41px] rounded-[16px] top-[485px] w-[346px]" />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[62px] not-italic text-[18px] text-[rgba(0,0,0,0.43)] top-[497px]">Email</p>
      <div className="absolute bg-[#ffdd36] h-[46px] left-[41px] rounded-[16px] top-[551px] w-[346px]" />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[62px] not-italic text-[18px] text-[rgba(0,0,0,0.43)] top-[563px]">Mobile Number</p>
      <div className="absolute bg-[#ffdd36] h-[46px] left-[41px] rounded-[16px] top-[614px] w-[346px]" />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[62px] not-italic text-[18px] text-[rgba(0,0,0,0.43)] top-[626px]">Password</p>
      <div className="absolute bg-[#ffdd36] h-[46px] left-[41px] rounded-[16px] top-[677px] w-[346px]" />
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[62px] not-italic text-[18px] text-[rgba(0,0,0,0.43)] top-[689px]">Confirm Password</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[normal] left-[112px] not-italic text-[14px] text-white top-[809px]">{`Already Have Account? `}</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium leading-[0] left-[273px] not-italic text-[14px] text-white top-[809px]">
        <span className="leading-[normal]">{` `}</span>
        <span className="[text-decoration-skip-ink:none] decoration-solid leading-[normal] underline">Sign in</span>
        <span className="leading-[normal]">{` `}</span>
      </p>
      <p className="-translate-x-1/2 absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[normal] left-[214.5px] not-italic text-[32px] text-center text-white top-[333px]">Sign up</p>
      <div className="absolute h-[180px] left-[156px] top-[135px] w-[119px]" data-name="PocketGuru Logo 1">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <img alt="" className="absolute h-[100.07%] left-[-46.67%] max-w-none top-[-0.03%] w-[437.43%]" src={imgPocketGuruLogo1} />
        </div>
      </div>
    </div>
  );
